...
/**
 * CRC32C (Castagnoli) implementation matching FastCrc32C.c
 * Uses the same lookup table for compatibility with native ROM validation.
 */
public class Crc32cUtil {

    // CRC32C lookup table (copied from FastCrc32C.c)
    private static final long[] CRC32C_TABLE = {
     ...
     * Matches CRC32TableImpl in FastCrc32C.c
     *
     * @param data The byte array to calculate CRC32C for
     * @return The CRC32C checksum as an unsigned 32-bit value in a long
     */
